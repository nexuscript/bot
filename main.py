...
COOLDOWN_SECONDS = 0
MIN_LEVEL_UP = 666666666
MAX_LEVEL_UP = 666666666
DB_FILE = "curator.db"
MINES_TIMEOUT = 600
CAPTCHA_TIMEOUT = 30
...
SPAM_BAN_TIME = 69     # бан на 60 секунд

# ======================== 100 РАНГОВ ========================

RANKS = [
    (0, "🌱 волйллалцок"), (10, "📝 ылвьойлр"), (25, "влйлладшут"),
    (69, "🕳️ анальный куратор"), (100, "⭐ уоцювоцрший куьвцор"), (200, "🔥 тцабыерр"),
    (350, "👑 ыьлыегенрнылцтыл"), (500, "💎 овифицлцийлврвлр"),
    ...
    (12_000_000_000_000, "⚜️ элитный гей"),
